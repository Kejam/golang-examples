...
type HelloServiceClient interface {
	GetHello(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Hello, error)
}
...
func (c *helloServiceClient) GetHello(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Hello, error) {
	out := new(Hello)
...
type HelloServiceServer interface {
	GetHello(context.Context, *Empty) (*Hello, error)
...
func (UnimplementedHelloServiceServer) GetHello(context.Context, *Empty) (*Hello, error) {
...
func _HelloService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/HelloService/getHello",
	}
